...
- [倒计时](https://www.bigtimer.net/?minutes=10&repeat=false)
- [MikuTools 一个轻量的工具集合](https://github.com/Ice-Hazymoon/MikuTools)

# 命令
- [Docker和Kubernetes常用命令（持续整理）](https://www.pkslow.com/archives/docker-kubernetes-frequently-used-commands)
- [kubectl好用的别名](https://github.com/ahmetb/kubectl-aliases)
...
- [Intellij IDEA](https://www.jetbrains.com/idea/)
    - [Intellij IDEA快捷键](https://resources.jetbrains.com/storage/products/intellij-idea/docs/IntelliJIDEA_ReferenceCard.pdf)
...
- [VSCode](https://code.visualstudio.com)
    - [VSCode插件](https://marketplace.visualstudio.com/VSCode)
    - [VSCode快把键 Mac](https://code.visualstudio.com/shortcuts/keyboard-shortcuts-macos.pdf)
    - [VSCode快把键 Windows](https://code.visualstudio.com/shortcuts/keyboard-shortcuts-windows.pdf)
